...
```     
The code above is used to import data and make some corrections on fonts so as to present both English and Chinese characters fluently. 
...
![KNN of Iris data](https://i.loli.net/2019/04/14/5cb33c4cbbd52.png)   
